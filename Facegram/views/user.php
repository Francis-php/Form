...
include "/var/www/html/Facegram/views/template.php";
    ...
    <body>
        ...
        <div class="editt">
            ...
            <div class="left-edit">
                <div class="pinfo">
                    ...
                    <div id="uploadimg" style="display:none;">            
                        <br>
                        <form action="/Facegram/user/profile/updateimg" method="POST" name="pictureForm" enctype="multipart/form-data" class="my-form">
                    ...
                    <br>
                    <form action="/Facegram/user/profile/updateinfo" name="infoForm" method="POST" class="my-form">
            ...
            <div class="right-edit">
                ...
                <div class="pinfo" >
                    <h2>Security</h2>
                    <form action="/Facegram/user/profile/updatepass" name="passwordForm" method="POST" class="my-form">
                        <div class="form-group">
