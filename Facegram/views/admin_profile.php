...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="left-edit">
            <div class="pinfo">
                ...
                <div id="uploadimg" style="display:none;">            
                    <br>
                    <form action="/Facegram/functionality/upload.php" method="POST" enctype="multipart/form-data" class="my-form">
                ...
                <br>
                <form action="/Facegram/functionality/change_data.php" method="POST" class="my-form">
        ...
        <div class="right-edit">
            ...
            <div class="pinfo" >
                <h2>Security</h2>
                <form action="/Facegram/functionality/change_pass.php" method="POST" class="my-form">
                    <div class="form-group">
