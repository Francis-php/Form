                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="button-container">
                                                ...
                                                <form action="/admin/users/delete" method="POST" name="deleteUsers">
                                                    <input type="hidden" name="delete_email" value="<?= $user['email'] ?>">
                                                    <button type="submit" class="ad-btn">Delete</button>
                                                
                                                </form>
                                                <form method="get" action="/admin/user/update" name="editUsers">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/admin/users/create" method="POST" name="createAdmin"
                            class="crt" id="krijim">
